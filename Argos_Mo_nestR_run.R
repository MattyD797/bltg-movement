...
individual <- read.csv("./Argos_Individual_Information_BTGO_Haanmeer.csv"); head(individual)
...
output2 <- BTGO_Haanmeer_output_2$nests %>%
  dplyr::filter(burst == "144129-2016") %>%
  slice(1)
