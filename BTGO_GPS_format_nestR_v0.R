...
setwd("C:/Users/14064/Dropbox/BTGO Movmement Study/Data/GPS Birds/CSV/")
...
#read in the data
movedata <- read.csv("./BTGO_Haanmeer_nestR.csv"); head(movedata)
...
# godwit.test <- BTGO_GPS_Haanmeer_nestR %>% filter(burst == "2002-2014")
#head(godwit.test)
